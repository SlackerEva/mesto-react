  ...
  return (
      <>
        ...
        <label className="sign-container__field">
            <input id="email-input" className="sign-container__input" type="url" name="email" onChange={handleChange} placeholder="Email" required />
            <span className="email-input-error"></span>
        </label>
        <label className="sign-container__field">
            <input id="password-input" className="sign-container__input" type="url" name="password" onChange={handleChange} placeholder="Пароль" required />
